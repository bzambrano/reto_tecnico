...
public class UpdateUserData implements Task {


    public static UpdateUserData throughService() {
        return instrumented(UpdateUserData.class);
    }
    ...
    public <T extends Actor> void performAs(T actor) {
        ...
        actor.remember(RESPONSE_SERVICE_UPDATE_USER.getKey(), SerenityRest.lastResponse().getBody().jsonPath());
